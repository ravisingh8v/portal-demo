...
# 2. Loop through the files in the temporary directory
...
for file in "$TEMP_DIR"/*; do
  ...
  # Set a flag to track if the file is excluded

  is_excluded=false



  # Check if 'name' is in the 'EXCLUDES' array
  ...
  # 3. Perform the copy only if the file is NOT excluded
